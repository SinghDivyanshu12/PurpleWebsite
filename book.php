	...
	<div class="hamburger_menu">
		...
		<div class="hamburger_menu_content text-right">
			<ul class="menu_top_nav">
				...
				<li class="menu_item"><a href="pages.php">pages</a></li>
...
const razorpayOptions = {
    ...
    "handler": function (response) {
        ...
        // Send the payment ID to your server for backend processing (verify the payment)
        ...
        // POST the payment details to your server to verify the payment signature
...
// Optional: Handle Razorpay payment failure scenario
window.addEventListener('error', function(event) {
    if (event.target && event.target.src && event.target.src.includes('checkout.js')) {
        alert('Error loading Razorpay checkout script. Please try again later.');
    }
});
